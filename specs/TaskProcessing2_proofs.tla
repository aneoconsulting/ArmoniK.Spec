...
LEMMA PartialRefineTaskProcessing == Spec => TP1Abs!Init /\ [][TP1Abs!Next]_TP1Abs!vars
...
<1>2. [Next]_vars => [TP1Abs!Next]_TP1Abs!vars
    ...
    <2>7. ASSUME NEW T \in SUBSET TaskId, FinalizeTasks(T)
